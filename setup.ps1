...
if (Test-Path ".env") {
    ...
    Write-Host "✓ .env file created. Please edit it with your Stripe API key" -ForegroundColor Green
}
...
Write-Host "3. Test: http://localhost:8080/api/v1/gateways/info" -ForegroundColor White
